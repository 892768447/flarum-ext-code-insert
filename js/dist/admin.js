...
/***/ "./src/admin/components/CodeSettingsModal.js":
/*!***************************************************!*\
  !*** ./src/admin/components/CodeSettingsModal.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CodeSettingsModal; });
...
var CodeSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(CodeSettingsModal, _SettingsModal);

  function CodeSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = CodeSettingsModal.prototype;
  ...
  _proto.form = function form() {
    ...
    }, m("label", null, app.translator.trans("flarum-ext-code-insert.admin.modes_label")), m("input", {
      required: true,
...
/* harmony import */ var _components_CodeSettingsModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/CodeSettingsModal */ "./src/admin/components/CodeSettingsModal.js");


flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('irony-code-insert', function (app) {
  app.extensionSettings['irony-code-insert'] = function () {
    return app.modal.show(new _components_CodeSettingsModal__WEBPACK_IMPORTED_MODULE_1__["default"]());
  };
});
